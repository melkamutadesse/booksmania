...
public class RegistrationForm extends javax.swing.JDialog {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (authorTextField.getText().isEmpty() || titleTextField.getText().isEmpty() || size == 0) {
            JOptionPane.showMessageDialog(null, "Fill all fields, please!", "Attention", JOptionPane.WARNING_MESSAGE);
            return;
        }
        try {
            ...
            if (bookID != 0){
                ...
                rw.writeConfig(conf);
                JOptionPane.showMessageDialog(null, "Book was registered!", "OK", JOptionPane.PLAIN_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Book wasn't registered!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception ex) {
