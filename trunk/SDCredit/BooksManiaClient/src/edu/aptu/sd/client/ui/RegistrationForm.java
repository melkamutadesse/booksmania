...
public class RegistrationForm extends javax.swing.JDialog {
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        try {
            ...
            Logger.log(RegistrationForm.class.getName(), ex, Level.SEVERE, Main.curPath);
        }
    ...
    private void browseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_browseButtonActionPerformed
        ...
        switch (fch.showOpenDialog(null)) {
            case JFileChooser.ERROR_OPTION:
                Logger.log(MainForm.class.getName(), "JFileChooser returned errror", Level.SEVERE, Main.curPath);
                break;
            case JFileChooser.APPROVE_OPTION:
                File f = fch.getSelectedFile();
                if (!f.exists()) {
                    Logger.log(MainForm.class.getName(), "File doesn't exist", Level.SEVERE, Main.curPath);
                }
