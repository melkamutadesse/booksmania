...
public class ObjectFactory {
    ...
    private final static QName _RemoveBookResponse_QNAME = new QName("http://server.sd.aptu.edu/", "removeBookResponse");
    private final static QName _SetUserStatusResponse_QNAME = new QName("http://server.sd.aptu.edu/", "setUserStatusResponse");
    private final static QName _RemoveBook_QNAME = new QName("http://server.sd.aptu.edu/", "removeBook");
    private final static QName _RegisterBookResponse_QNAME = new QName("http://server.sd.aptu.edu/", "registerBookResponse");
    private final static QName _RegisterBookCopyResponse_QNAME = new QName("http://server.sd.aptu.edu/", "registerBookCopyResponse");
    private final static QName _RegisterUser_QNAME = new QName("http://server.sd.aptu.edu/", "registerUser");
    private final static QName _RegisterBookCopy_QNAME = new QName("http://server.sd.aptu.edu/", "registerBookCopy");
    ...
    /**
     * Create an instance of {@link RegisterBookCopy }
     * 
     */
    public RegisterBookCopy createRegisterBookCopy() {
        return new RegisterBookCopy();
    }
    ...
    /**
     * Create an instance of {@link RegisterBookCopyResponse }
     * 
     */
    public RegisterBookCopyResponse createRegisterBookCopyResponse() {
        return new RegisterBookCopyResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.sd.aptu.edu/", name = "removeBookResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.sd.aptu.edu/", name = "removeBook")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RegisterBookCopyResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://server.sd.aptu.edu/", name = "registerBookCopyResponse")
    public JAXBElement<RegisterBookCopyResponse> createRegisterBookCopyResponse(RegisterBookCopyResponse value) {
        return new JAXBElement<RegisterBookCopyResponse>(_RegisterBookCopyResponse_QNAME, RegisterBookCopyResponse.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RegisterBookCopy }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://server.sd.aptu.edu/", name = "registerBookCopy")
    public JAXBElement<RegisterBookCopy> createRegisterBookCopy(RegisterBookCopy value) {
        return new JAXBElement<RegisterBookCopy>(_RegisterBookCopy_QNAME, RegisterBookCopy.class, null, value);
    }
